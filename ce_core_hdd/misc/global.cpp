...
void preloadGlobalsFromDotEnv(void)
{
    ...
    logHdd(LOG_DEBUG, "CORE_PATH        : %s", corePath.c_str());
    logHdd(LOG_DEBUG, "driversPath      : %s", driversPath.c_str());
    logHdd(LOG_DEBUG, "CONFIG_DRIVE_PATH: %s", CONFIG_DRIVE_PATH.c_str());
}
