...
CE_PASTI_API BOOL pastiInit( struct pastiINITINFO *);

CE_PASTI_API BOOL pastiConfig( struct pastiCONFIGINFO *);
CE_PASTI_API BOOL pastiGetConfig( struct pastiCONFIGINFO *);
CE_PASTI_API BOOL pastiHwReset( BOOL bPowerUp);
CE_PASTI_API int pastiGetLastError( void);

CE_PASTI_API BOOL pastiIo( int mode, struct pastiIOINFO *);
CE_PASTI_API BOOL pastiWritePorta( unsigned data, long cycles);

CE_PASTI_API BOOL pastiImgLoad( int drive, BOOL bWprot, BOOL bDelay, long cycles,
				struct pastiDISKIMGINFO *);
CE_PASTI_API BOOL pastiSaveImg( int drive, BOOL bAlways, pastiDISKIMGINFO *);
...
CE_PASTI_API BOOL pastiGetBootSector( int drive, struct pastiBOOTSECTINFO *);

CE_PASTI_API BOOL pastiPeek( struct pastiPEEKINFO *);
CE_PASTI_API BOOL pastiBreakpoint( unsigned subfunc, int n, struct pastiBREAKINFO *);

CE_PASTI_API BOOL pastiSaveState( struct pastiSTATEINFO *);
CE_PASTI_API BOOL pastiLoadState( struct pastiSTATEINFO *);

CE_PASTI_API BOOL pastiLoadConfig( struct pastiLOADINI *, struct pastiCONFIGINFO *);
CE_PASTI_API BOOL pastiSaveConfig( struct pastiLOADINI *, const struct pastiCONFIGINFO *);

CE_PASTI_API BOOL pastiDlgConfig( HWND hWnd, unsigned flags,
											struct pastiCONFIGINFO *);
