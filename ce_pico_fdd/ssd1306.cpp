...
{
    uint8_t buf[2] = {0, cmd};
    int res = i2c_write_blocking(i2c_default, SSD1306_I2C_ADDRESS, buf, 2, false);
...
void SSD1306::display(void)
{
    ...
    for (y=0; y<SSD1306_LCDHEIGHT; y++) {
        ...
        i2c_write_blocking(i2c_default, SSD1306_I2C_ADDRESS, bfr, SSD1306_BYTES_PER_LINE + 1, false);
    }
}
