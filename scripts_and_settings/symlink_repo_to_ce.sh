...
rm -f /ce/update/check_for_update.sh
rm -f /ce/update/check_and_flash_chips.sh
...
ln -fs /shared/ce-atari/scripts_and_settings/check_for_update.sh       /ce/update/check_for_update.sh
ln -fs /shared/ce-atari/scripts_and_settings/check_and_flash_chips.sh  /ce/update/check_and_flash_chips.sh
