#ifndef __CHIPINTERFACE_RASCSI_H__
#define __CHIPINTERFACE_RASCSI_H__

#include <stdint.h>
#include "../chipinterface_v1_v2/chipinterface12.h"

// RaSCSI hardware support.
...
class ChipInterfaceRaSCSI: public ChipInterface12
{
public:
    ChipInterfaceRaSCSI();
    virtual ~ChipInterfaceRaSCSI();
